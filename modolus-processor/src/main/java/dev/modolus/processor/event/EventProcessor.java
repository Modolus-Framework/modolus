...
public final class EventProcessor extends Processor {
    ...
    private static final ClassName LAZY_CLASS_NAME = ClassName.get("dev.modolus.util.singleton", "Lazy");
    private static final ClassName EVENT_LISTENER_CLASS_NAME = ClassName.get("dev.modolus.core.event", "EventListener");
